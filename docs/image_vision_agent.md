...
> **Document**: `Cure-Quest/docs/image_vision_agent.md`
...
│    → CureQuest/Doctor-X/Patient-Y/{Category}/       │
│                                                     │
...
|--------|------|-------------|
| **MODIFY** | `Cure-Quest/src/.../services/gemini_vision.py` | Add `auto_analyze_image()` with fallback chain |
| **NEW** | `src/cure_quest/adk/vision_agent.py` | Vision LlmAgent definition with A2A tools |
| **MODIFY** | `src/cure_quest/adk/orchestrator_agent.py` | Wire vision_agent via AgentTool |
| **MODIFY** | `src/cure_quest/adk/agent.py` | Wire vision_agent to root agent |
| **MODIFY** | `src/cure_quest/agent.py` | Expose in `adk web` dropdown |
