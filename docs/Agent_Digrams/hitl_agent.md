...
> **Document**: `Cure-Quest/docs/hitl_agent.md`
...
3. **Doctor Workspace Integration**: Syncs case status (open, in-review, resolved) between external ticketing tools and the Cure-Quest internal database.
...
- [ ] `adk web src` → `cure_quest_hitl_agent` appears in dropdown
