...
> **Document**: `Cure-Quest/docs/data_fetcher_agent.md`
...
graph TD
    ...
    DFA --> MCP["Cure-Quest MCP Server<br/>(Model Context Protocol)"]
...
- [ ] `adk web src` → `cure_quest_data_fetcher_agent` appears in dropdown
