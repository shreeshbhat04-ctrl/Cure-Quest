  ...
  return (
    <div className="nurture-card w-full h-full flex min-h-[clamp(22rem,58vh,40rem)] flex-col items-center justify-center gap-4 text-center">
      ...
      <div>
        ...
        <p className="mt-2 max-w-md text-sm leading-7 text-on-surface/60">
          Cure-Quest is gathering your routines, medication signals, and care coordination details.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="nurture-card w-full h-full flex min-h-[clamp(22rem,58vh,40rem)] flex-col items-center justify-center gap-4 text-center">
      ...
      <div>
        ...
        <p className="mt-2 max-w-lg text-sm leading-7 text-on-surface/65">{message}</p>
      </div>
      {onRetry ? (
  ...
  return (
    <div className="nurture-card w-full h-full flex min-h-[clamp(20rem,42vh,30rem)] flex-col items-center justify-center gap-3 text-center">
      ...
      <div>
        ...
        <p className="mt-2 max-w-md text-sm leading-7 text-on-surface/60">{description}</p>
      </div>
    </div>
  );
}
