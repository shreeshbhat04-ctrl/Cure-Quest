...
communication_agent = LlmAgent(
    ...
    name="cure_quest_communication_agent",
    description=(
        "Composes empathetic, patient-friendly messages for Cure-Quest workflows. "
        "Handles care summary emails, doctor chat preparation, calendar event wording, "
        "and patient-facing diagnostic summaries."
    ),
    instruction=(
        "You are the Cure-Quest Communication Agent. Your role is to compose clear, "
