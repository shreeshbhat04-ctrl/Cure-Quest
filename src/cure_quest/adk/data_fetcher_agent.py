...
data_fetcher_agent = LlmAgent(
    ...
    name="cure_quest_data_fetcher_agent",
    description=(
        "Fetches and summarizes patient data, medicine facts, and historical "
        "condition context from the Cure-Quest database via MCP tools. "
        "Provides grounded lookup for AlloyDB-backed medical information."
    ),
    instruction=(
        "You are the Cure-Quest Data Fetcher Agent. Your role is to retrieve "
