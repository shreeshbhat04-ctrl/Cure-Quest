...
from cure_quest.api.models import PatientIntakeRequest, ConditionInput
from cure_quest.db.bootstrap import init_database
from cure_quest.db.session import SessionLocal, Base, engine
...
def seed_database():
    ...
    try:
        ...
        comms.notify(
            ...
            message_body="Welcome to Cure-Quest demo workspace."
        )
    except Exception as e:
